...
Border Radius Previewer with a result in CSS and a copy to clipboard

I'm improving this project using Vue right [here](https://github.com/dre1597/border-preview-vue) making now a border-previewer not only border-radius.
